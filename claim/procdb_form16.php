...
<?php
    ...
    mysqli_query ($con_form16, "INSERT INTO  form16(ชื่อ, นามสกุล, รหัสนิสิต, เบอร์โทรศัพท์, email, การเรียนการสอน, คณะ, รหัสสาขา, ชั้นปี,  เนื่องจาก, รหัสวิชา, ชื่อวิชา, จำนวนหน่วยกิต, หมู่เรียน,สถานะ)
