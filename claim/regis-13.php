...
<html>
    <head>
        <meta charset="utf8">
        <title>คำร้องขอเทียบรายวิชา</title>
...
<body  background="BG17.jpg" >
    ...
    <form action="procdb_form13.php" method="post">
            <div class="container">        
                <img src="logo.png" width="150" height="150" >
                    <h1>คำร้องขอเทียบรายวิชา</h1><br>
            ...
            <div class="form-group"> 
                <div class="col-sm-2 control-label">
                    <div class="input-group mb-3">
                        ...
                        <h2> มีความประสงค์ขอเทียบรายวิชา ในภาค </h2>
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" for="รายวิชาที่เรียน">รายวิชาที่เรียน</label>
                                </div>
                                    <input type="text" class="form-control" name="รหัสวิชาที่เรียน" placeholder="รหัสวิชา">
                                    <input type="text" class="form-control" name="ชื่อวิชาที่เรียน" placeholder="ชื่อวิชา">
                                    <input type="text" class="form-control" name="ผลการเรียนที่เรียน" placeholder="ผลการเรียน">       
                            </div>  
                        

                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <label class="input-group-text" for="รายวิชาที่ขอเทียบตามหลักสูตร">รายวิชาที่ขอเทียบตามหลักสูตร</label>
                              </div>
                                <input type="text" class="form-control" name="รหัสวิชาที่ขอเทียบ"   placeholder="รหัสวิชา">
                                <input type="text" class="form-control" name="ชื่อวิชาที่ขอเทียบ"    placeholder="ชื่อวิชา">
                                <input type="text" class="form-control" name="ผลการเรียนที่ขอเทียบ" placeholder="ผลการเรียน">
                            </div>  
