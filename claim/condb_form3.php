...
<body>
	...
	$con_form3 =  mysqli_connect("localhost","root"," ","form");
	mysqli_set_charset($con_form3,"utf8");

		if(mysqli_connect_error($con_form3)) {
			echo "Failed";
		}
...
$query =  ($search ? " SELECT * FROM `form3` WHERE `รหัสนิสิต` LIKE '$search' " : " SELECT * FROM `form3`")
		   or die("Error:" . mysqli_error());

$result = mysqli_query($con_form3, $query);
...
?>
    ...
    echo "</table>";*/
            ...
            <tr>
                ...
                <td> <a href="php/update.php?ID_form3=<?php echo $row["ID_form3"]; ?>"
