...
<html>
    <head>
        <meta charset="utf8">
        <title>ใบคำร้องขอย้ายหลักสูตร/สาขาวิชาเอก</title>
...
<body  background="BG17.jpg" >
        ...
        <form action="procdb_form12.php" method="post">
            <div class="container">        
                <img src="logo.png" width="150" height="150" >
                    <h1>ใบคำร้องขอย้ายหลักสูตร/สาขาวิชาเอก</h1><br>
            ...
            <div class="form-group"> 
                ...
                <h2> ขอย้ายเข้าศึกษาในสาขาวิชา </h2>
                <input type="text" class="form-control" name="ขอย้ายเข้าสาขา" placeholder="ชื่อสาขา"><br>


                <br><h2>ตั้งแต่ภาค</h2><br> 
