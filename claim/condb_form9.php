...
<?php
	...
	$con_form9 =  mysqli_connect("localhost","root","","form");
	mysqli_set_charset($con_form9,"utf8");

		if(mysqli_connect_error($con_form9)) {
			echo "Failed";
		}
...
$query =  ($search ? " SELECT * FROM `form9` WHERE `รหัสนิสิต` LIKE '$search' " : " SELECT * FROM `form9`")
		   or die("Error:" . mysqli_error());

$result = mysqli_query($con_form9, $query);
...
<div class="form-group">
      ...
      while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td> <a href="php/update.php?ID_form9=<?php echo $row["ID_form9"]; ?>"
