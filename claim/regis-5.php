...
<html>
    <head>
        <meta charset="utf-8">
        <title>คำร้องขอลงทะเบียนเรียน เกิน/ต่ำกว่าปกติ</title>
...
<body  background="BG17.jpg" >
    ...
    <form action="procdb_form5.php" method="post">
        <div class="container">        
            <img src="logo.png" width="150" height="150" >
                <br><h1>คำร้องขอลงทะเบียนเรียน เกิน/ต่ำกว่าปกติ <font color="#FF0000">สำหรับนิสิตภาคการศึกษาสุดท้ายที่จะสำเร็จการศึกษา</font></h1><br>
            ...
            <h2><font color="#FF0000">มีความประสงค์ ขอลงทะเบียน ในภาค</font></h2>
            ...
            <br><h2><font color="#FF0000">ต้องการเรียนเกิน/ต่ำกว่าปกติ</font></h2>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="เรียนเกิน 22 หน่วยกิต " name="เรียนเกิน/ต่ำกว่าปกติ" value="เกิน 22 หน่วยกิต">
                <label class="custom-control-label" for="เรียนเกิน 22 หน่วยกิต "><font color="#000000">เรียนเกิน 22 หน่วยกิต</font></label>
                
                
            </div>

            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="เรียนเกิน 7 หน่วยกิต " name="เรียนเกิน/ต่ำกว่าปกติ" value="เกิน 7 หน่วยกิต">
                <label class="custom-control-label" for="เรียนเกิน 7 หน่วยกิต "><font color="#000000">เรียนเกิน 7 หน่วยกิต</font></label>
                
                
            </div>

            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="เรียนต่ำกว่า 9 หน่วยกิต " name="เรียนเกิน/ต่ำกว่าปกติ" value="ต่ำกว่า 9 หน่วยกิต">
                <label class="custom-control-label" for="เรียนต่ำกว่า 9 หน่วยกิต "><font color="#000000">เรียนต่ำกว่า 9 หน่วยกิต</font></label><br>
                
            </div><br>

        <br><div class="ustom-control-inline" >
            <label><h5><font color="#000000">โดยมีจำนวนรวม</font></h5></label>
                <input type="text" name="จำนวนหน่วยกิตรวม">
                <font color="#FF0000">หน่วยกิต</font><br>
            <label><h5><font color="#000000">โดยมีวิชาที่ลงทะเบียนปัจจุบันแล้ว จำนวน</font></h5></label>
            <input type="text" name="หน่วยกิตปัจจุบัน">
            <font color="#FF0000">หน่วยกิต</font><br>
        </div>
            <br>
            ...
            <div >
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">รายวิชาที่ต้องลงเกิน/ต่ำกว่าปกติ</span>
                    </div>
                ...
                <div class="form-group">
                    <h3>เอกสารที่นิสิตต้อง Upload</h3>                             
                        <div class="form-group has-success">
                            ...
                            <label>1.ผลการเรียนเทียบหลักสูตร
                            <font color="#FF0000">ชื่อไฟล์ไม่ควรมีเครื่องหมาย +/'* </font></label>
                            <input name="file_regis" class="form-control" type="file" id="file_regis" onChange="readURL4(this);" />
                            <img id="blah4" src="#" alt="" hight="170" width="270"/><br/>
                                              
                        

                            <label>2.ใบเกรด(GPA) <font color="#FF0000">ชื่อไฟล์ไม่ควรมีเครื่องหมาย +/'  
                            </font><font color="#FF0000">*</font></label>
                            <input name="file_gpa" class="form-control" type="file" id="file_gpa" onChange="readURL6(this);" />
