...
<html>
    <head>
        ...
        <title>คำร้องขอรักษาสถานสภาพนิสิต</title>
...
<body  background="BG17.jpg" >
        ...
        <form action="procdb_form19.php" method="post">
                        <div class="container">
                            <img src="logo.png" width="150" height="150" >
                            <br><h1>คำร้องขอรักษาสถานสภาพนิสิต</h1><br>
                        ...
                        <h2> โดยขอรักษาสถานภาพนิสิตในภาค </h2>
            ...
            <div class="container">
                <h2>ความประสงค์ที่จะขอรักษาสถานภาพนิสิต</h2>
                <p>ระบุความประสงค์:</p>
                <form action="/action_page.php">
                    <div class="form-group">
                        <textarea class="form-control" rows="5" id="comment" name="ความประสงค์"></textarea>
                    </div>
