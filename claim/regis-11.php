...
<form action="procdb_form11.php" method="post">
        <div class="container">        
            <img src="logo.png" width="150" height="150" >
                <h1>คำร้องขอย้ายคณะ</h1><br>
                            ...
                            <div class="col-sm-4 control-label ">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        ...
                                        <select class="custom-select" id="การเรียนการสอน" name="การเรียนการสอน" >
                        ...
                        <div class="col-sm-2 control-label ">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <select class="custom-select" id="คณะ" name="คณะ" >
                                        <option selected>-เลือกข้อมูล-</option>
                        ...
                        <div class="col-sm-2 control-label">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <select class="custom-select" id="รหัสสาขา" name="รหัสสาขา">
                                    <option selected>-เลือกข้อมูล-</option>
                        ...
                        <div class="col-sm-2 control-label">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <select class="custom-select" id="ชั้นปี" name="ชั้นปี">
                                    <option selected>-เลือกข้อมูล-</option>
                    ...
                    <h2> มีความประสงค์ขอย้ายเข้าศึกษาคณะ </h2>
                       
                       <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                 <label class="input-group-text" for="ย้ายเข้าคณะ">ประสงค์ย้ายเข้าคณะ</label> 
                                </div>
                                <input type="text" class="form-control" name="ย้ายเข้าคณะ" placeholder="ชื่อคณะ" >
                        </div>

                         <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                 <label class="input-group-text" for="ย้ายเข้าสาขา">ประสงค์ย้ายเข้าสาขา</label> 
                                </div>
                                 <input type="text" class="form-control" name="ย้ายเข้าสาขา" placeholder="สาขา">
                                 <input type="text" class="form-control" name="รหัสสาขาที่ย้ายเข้า" placeholder="รหัสสาขา">
                        </div>
                    ...
                    <div >
                       <h2>เนื่องจาก</h2>
                        ...
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                             <label class="input-group-text" for="ผู้ปกครอง">คำรับรองผู้ปกครอง</label> 
                          </div>
                            <input type="text" class="form-control" name="ชื่อผู้ปกครอง" placeholder="ชื่อ">
                            <input type="text" class="form-control" name="นามสกุลผู้ปกครอง" placeholder="นามสกุล">
                        </div>   
                        
                       <div class="input-group mb-3">
                            <div class="input-group-prepend">
                             <label class="input-group-text" for="เบอร์ผู้ปกครอง">ช่องทางการติดต่อ</label> 
                            </div>
                            <input type="text" class="form-control" name="เบอร์ผู้ปกครอง" placeholder="เบอร์โทรศัทพ์ผู้ปกครอง">
                        </div>
                   
                        
                        <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                        <label class="input-group-text" for="อนุญาติ">อนุญาติ/ไม่อนุญาติ</label>               
                                        <select class="custom-select" id="อนุญาติ"  name="อนุญาติ" >
                                            <option selected>-เลือกข้อมูล-</option>
                        ...
                        <div class="input-group mb-3">
                        <div class="input-group-prepend">
                           <label class="input-group-text" for="ความสัมพันพ์เป็น">ความสัมพันพ์เป็น</label>
                        </div>
                            <input type="text" size="10" class="form-control" name="ความสัมพันพ์เป็น" placeholder="ของข้าพเจ้า">
                        </div>
                            
                            ย้ายคณะตามความประสงค์และเหตุผลดังกล่าวข้างต้น<br>
