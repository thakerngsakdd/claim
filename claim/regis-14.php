...
<body  background="BG17.jpg" >
    ...
    <form action="procdb_form14.php" method="post">
                        
            <div class="container">
                <img src="logo.png" width="150" height="150" >
                <br><h1>คำร้องขอเทียบโอนหน่วยกิต</h1><br>
            ...
            <div class="form-group"> 
                <div class="col-sm-2 control-label">
                    <div class="input-group mb-3">
                        ...
                        </div><h2>มีความประสงค์ขอเทียบโอนหน่วยกิต จากผลการเรียนเลขประจำตัว(เดิม)</h2>
                        
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" name= "เลขประจำตัวเดิม" placeholder="เลขประจำตัวเดิม">
                        </div>  
              
                    
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <label class="input-group-text" for="รายวิชาที่ขอเทียบโอน">รายวิชาที่ขอเทียบโอน</label>
                          </div>
