...
<html>
    <head>
        ...
        <title>คำร้องขอคืนสถานสภาพนิสิต</title>
...
<body  background="BG.jpg" >
        ...
        <form action="procdb_form20.php" method="post">
                        <div class="container">
                            <img src="logo.png" width="150" height="150" >
                            <br><h1>คำร้องขอคืนสถานสภาพนิสิต</h1><br>
                            ...
                            <h2> โดยขอคืนสถานภาพนิสิตในภาค </h2>
                            ...
                            <div class="container">
                                <h2>ความประสงค์ที่จะขอคืนสภาพนิสิต</h2>
                                <p>ระบุความประสงค์:</p>
