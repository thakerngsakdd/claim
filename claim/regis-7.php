...
<html>
    <head>
        <meta charset="utf-8">
        <title>คำร้องขอลงทะเบียนเรียน Audit</title>
...
<form action="procdb_form7.php" method="post">
            <div class="container">        
                <img src="logo.png" width="150" height="150" >
                    <br><h1>คำร้องขอลงทะเบียนเรียน Audit</h1><br>
            ...
            <div class="container">
               ...
               <h2>เนื่องจาก</h2>
                ...
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <label class="input-group-text">รายวิชาที่ต้องลงดังนี้</label>
                  </div>
                 ...
                 <div class="col-md-6">          
                    <div class="form-group">
                        ...
                        <div class="form-group has-success">
                            ...
                            <label>1.รายงานผลการลงทะเบียนเรียน
                    ...
                    <div class="container">
                        ...
                        <a href="claim.php"><button>กลับหน้าแรก</button>
                            </a>
                    </div>
