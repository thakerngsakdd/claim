...
<html>
    <head>
        ...
        <meta charset="utf8">
        <title>คำร้องขอสอบชดใช้(กรณีป่วย)</title>
...
<body  background="BG17.jpg" >
                ...
                <form action="procdb_form16.php" method="post">
                        
                        <div class="container">
                            <img src="logo.png" width="150" height="150" >
                            <br><h1>คำร้องขอสอบชดใช้(กรณีป่วย)</h1><br>
                    ...
                    <br><h2><font color="#FF0000">*กรุณาส่งใบรับรองแพทย์ที่ทำการคณะ*</font></h2>
