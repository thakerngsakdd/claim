...
<html>
    <head>
        <meta charset="utf-8">
        <title>คำร้องขอถอนรายวิชาเรียนจำนวนหน่อยกิตคงเหลือน้อยกว่า 9 หน่วยกิต</title>
...
<body background="BG12.jpg">
    ...
    <form action="procdb_form4.php" method="post">
            <div class="container"> 
            <img src="logo.png" width="150" height="150" >       
                    <br><h2 >คำร้องขอถอนรายวิชาเรียนจำนวนหน่อยกิตคงเหลือน้อยกว่า 9 หน่วยกิต</h2><br>
            ...
            <h2> มีความประสงค์ ขอลงทะเบียน ในภาค </h2>
            ...
            <label><font color="#ffffff"><font color="#ffffff">เปลี่ยนจาก</font></label>
            <input type="text" name="เปลี่ยนจาก">
            <font color="#FF0000">หน่วยกิต</font></font></font><br>
            
            <label><font color="#ffffff">เป็น</font></label>
            <input type="text" name="เป็น">
            ...
            <div class="container">
                ...
                <div >
                   <h2>เนื่องจาก</h2>
                        ...
                        <p><font color="#ffffff">โดยมีรายวิชาที่ลงดังนี้</font></p>
                </div>
                   
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">รายวิชาที่ต้องงดเรียนดังนี้</span>
                     </div>
