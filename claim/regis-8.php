...
<html>
    <head>
        <meta charset="utf-8">
        <title> คำร้องขอลงทะเบียนเรียนข้ามสถาบัน / ข้ามวิทยาเขต</title>
...
<body  background="BG17.jpg" >
        ...
        <form action="procdb_form8.php" method="post"><br>
            <div class="container">        
                <img src="logo.png" width="150" height="150" >
                    <h1>คำร้องขอลงทะเบียนเรียนข้ามสถาบัน / ข้ามวิทยาเขต</h1><br>
            ...
            <h2> มีความประสงค์ขอเรียนข้ามวิทยาเขต/สถาบัน ในภาค </h2>
            ...
            <link rel="stylesheet" href="bootstrap.min.css"> 
               ...
               <h2>เนื่องจาก</h2>
                ...
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text">รายวิชาที่ต้องลงดังนี้</span>
                  </div>
                ...
                <div class="form-group">
                    <h3>เอกสารที่นิสิตต้อง Upload</h3>                             
                        <div class="form-group has-success">
                            ...
                            <label>1.ใบชำระค่าธรรมเนียมการศึกษา
                            <font color="#FF0000">ชื่อไฟล์ไม่ควรมีเครื่องหมาย +/'* </font></label>
                            <input name="file_bill" class="form-control" type="file" id="file_bill" onChange="readURL4(this);" />
