...
<?php
	...
	$con_form6 =  mysqli_connect("localhost","root","","form");
	mysqli_set_charset($con_form6,"utf8");

		if(mysqli_connect_error($con_form6)) {
			echo "Failed";
		}
...
$query =  ($search ? " SELECT * FROM `form6` WHERE `รหัสนิสิต` LIKE '$search' " : " SELECT * FROM `form6`")
		   or die("Error:" . mysqli_error());

$result = mysqli_query($con_form6, $query);
    ...
    ?>*/
     ...
     while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td> <a href="php/update.php?ID_form6=<?php echo $row["ID_form6"]; ?>"
