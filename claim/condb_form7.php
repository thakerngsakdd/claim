...
<?php
	...
	$con_form7 =  mysqli_connect("localhost","root","","form");
	mysqli_set_charset($con_form7,"utf8");

		if(mysqli_connect_error($con_form7)) {
			echo "Failed";
		}
...
$query =  ($search ? " SELECT * FROM `form7` WHERE `รหัสนิสิต` LIKE '$search' " : " SELECT * FROM `form7`")
		   or die("Error:" . mysqli_error());

$result = mysqli_query($con_form7, $query);
...
<div class="form-group">
      ...
      while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td> <a href="php/update.php?ID_form7=<?php echo $row["ID_form7"]; ?>"
