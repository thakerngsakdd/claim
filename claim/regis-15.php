...
<html>
    <head>
        <meta charset="utf8">
        <title>คำร้องขอลงทะเบียนเรียนรายวิชาต่อเนื่องควบคู่กับรายวิชาบังคับก่อน</title>
...
<body>
            ...
            <form action="procdb_form15.php" method="post">
                    <div class="container">        
                        <img src="logo.png" width="150" height="150" >
                        <br><h1>คำร้องขอลงทะเบียนเรียนรายวิชาต่อเนื่องควบคู่กับรายวิชาบังคับก่อน</h1><br>
                ...
                <div class="col-sm-2 control-label">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            ...
                            <br><h2> มีความประสงค์ขอเรียนควบรายวิชา ในภาค</h2>
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label>คะแนนเฉลี่ยสะสม</label>
                                    <input type="text" name="คะแนนเฉลี่ยสะสม"><br>

                            
                        
                                <br><div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <label class="input-group-text">วิชาบังคับก่อน</label>
                                  </div>
                                    <input type="text" class="form-control"  name="รหัสวิชาวิชาบังคับก่อน"   placeholder="รหัสวิชา">
                                    <input type="text" class="form-control"  name="ชื่อวิชาวิชาบังคับก่อน"   placeholder="ชื่อวิชา">
                                    <input type="text" class="form-control"  name="ระดับคะแนนเดิม"   placeholder="ระดับคะแนน(เดิม)">
                                    <input type="text" class="form-control"  name="หมู่ลงทะเบียนเทอมปัจจุบัน"   placeholder="หมู่เรียน(ลงทะเบียนเทอมปัจจุบัน)">

                                </div>  
                                                    
                                <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <label class="input-group-text">วิชาต่อเนื่อง</label>
                                  </div>
                                    <input type="text" class="form-control"  name="รหัสวิชาวิชาต่อเนื่อง"   placeholder="รหัสวิชา">
                                    <input type="text" class="form-control"  name="ชื่อวิชาวิชาต่อเนื่อง"   placeholder="ชื่อวิชา">
                                    <input type="text" class="form-control"  name="หมู่เรียนวิชาต่อเนื่อง"   placeholder="หมู่เรียน">
                                </div>  
