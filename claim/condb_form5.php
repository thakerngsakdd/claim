...
<?php
	...
	$con_form5 =  mysqli_connect("localhost","root","","form");
	mysqli_set_charset($con_form5,"utf8");

		if(mysqli_connect_error($con_form5)) {
			echo "Failed";
		}
...
$query =  ($search ? " SELECT * FROM `form5` WHERE `รหัสนิสิต` LIKE '$search' " : " SELECT * FROM `form5`")
		   or die("Error:" . mysqli_error());

$result = mysqli_query($con_form5, $query);
...
<div class="form-group">
      ...
      while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td> <a href="php/update.php?ID_form5=<?php echo $row["ID_form5"]; ?>"
