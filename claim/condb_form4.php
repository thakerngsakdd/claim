...
<?php
	...
	$con_form4 =  mysqli_connect("localhost","root","","form");
	mysqli_set_charset($con_form4,"utf8");

		if(mysqli_connect_error($con_form4)) {
			echo "Failed";
		}
...
$query =  ($search ? " SELECT * FROM `form4` WHERE `รหัสนิสิต` LIKE '$search' " : " SELECT * FROM `form4`")
		   or die("Error:" . mysqli_error());

$result = mysqli_query($con_form4, $query);
    ...
    echo "</table>";*/
       ...
       while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td> <a href="php/update.php?ID_form4=<?php echo $row["ID_form4"]; ?>"
