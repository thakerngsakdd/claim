...
<html>
    <head>
        <meta charset="utf-8">
        <title>คำร้องขอลงทะเบียนเรียน เพื่อเปลี่ยนแต้มระดับคะแนนเฉลี่ยสะสม(Re-grade)</title>
...
<body  background="BG17.jpg" >
     ...
     <form action="procdb_form6.php" method="post">
        <div class="container">        
            <img src="logo.png" width="150" height="150" >
                <br><h1>คำร้องขอลงทะเบียนเรียน เพื่อเปลี่ยนแต้มระดับคะแนนเฉลี่ยสะสม(Re-grade)</h1><br>
            ...
            <h2> มีความประสงค์ขอลงทะเบียนเรียนเพื่อเปลี่ยนแต้มระดับคะแนนเฉลี่ยสะสม ในภาค </h2>
                ...
                <div class="form-group">
                    <h3>เอกสารที่นิสิตต้อง Upload</h3>                             
                        <div class="form-group has-success">
                            ...
                            <label>1.ใบเกรด(GPA) <font color="#FF0000">ชื่อไฟล์ไม่ควรมีเครื่องหมาย +/'  
                            ...
                            <label>2.รายงานการลงทะเบียนเทอมปัจจุบัน <font color="#FF0000">ชื่อไฟล์ไม่ควรมีเครื่องหมาย +/'  
                            </font><font color="#FF0000">*</font></label>
                            <input name="file_regis" class="form-control" type="file" id="file_report" onChange="readURL6(this);" />
                            <img id="blah6" src="#" alt="" hight="170" width="270"/><br/>
