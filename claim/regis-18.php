...
<body  background="BG17.jpg" >
    ...
    <body>
        <form action="procdb_form18.php" method="post">
            
           <div class="container">
               <img src="logo.png" width="150" height="150" >
                            <br><h1>คำร้องขอลาพักการศึกษา</h1><br>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 control-label">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" for="กำหนดการขอพักการศึกษา/ภาค">กำหนดการขอพักการศึกษา/ภาค</label>
                                </div>
                                <select class="custom-select" id="กำหนดการขอพักการศึกษา/ภาค" name="กำหนดการขอพักการศึกษา" required>
                                    <option selected>-เลือกข้อมูลภาคเรียน-</option>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="ปีการศึกษา">ปีการศึกษา</label> 
                        </div>
                            <input type="text" class="form-control"  id="ปีการศึกษา"  name="ปีการศึกษา" placeholder="ปีการศึกษา"required=true>
                    </div>  
                    ...
                    <div class="container">
                        <h2>ความประสงค์ที่จะขอลาพักการศึกษา</h2>
                        <p>ระบุความประสงค์:</p>
                        
                            <div class="form-group">
                                <textarea class="form-control" rows="5" id="ระบุความประสงค์" name="ความประสงค์ที่จะขอลาพักการศึกษา"></textarea>
                            </div>

                        
                    </div>
                    <div class="container">
                        <h2>คำยินยอมของผู้ปกครอง</h2>
                        <p>ระบุคำยินยอม:</p>
                        
                            <div class="form-group">
                                <textarea class="form-control" rows="5" id="ระบุคำยินยอม" name="คำยินยอมของผู้ปกครอง"></textarea>
                            </div>

                        
                    </div>
                    <br><h2><font color="#FF0000">*กรุณาส่งหลักฐานไปยังที่ทำการคณะ*</font></h2>
