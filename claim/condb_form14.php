...
<?php
	...
	$con_form14 =  mysqli_connect("localhost","root","","form");
	mysqli_set_charset($con_form14,"utf8");

		if(mysqli_connect_error($con_form14)) {
			echo "Failed";
		}
...
$query =  ($search ? " SELECT * FROM `form14` WHERE `รหัสนิสิต` LIKE '$search' " : " SELECT * FROM `form14`")
		   or die("Error:" . mysqli_error());

$result = mysqli_query($con_form14, $query);
...
<div class="form-group">
      ...
      while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td> <a href="php/update.php?ID_form14=<?php echo $row["ID_form14"]; ?>"
